...
import com.dino.plExplorer.service.matches.MatchesSyncService;
...
public class DevDataSeeder {
    ...
    private final MatchesSyncService    matchesSyncService;
    ...
    public void seedDevData() {
        ...
        try {
           ...
           // }
             // matchesSyncService.syncMatchesForGameweek(35, Optional.of(2025));
